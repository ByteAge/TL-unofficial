...
public class SendMessagesHelper implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static void prepareSendingPhoto(String imageFilePath, Uri imageUri, long dialog_id, MessageObject reply_to_msg, CharSequence caption, boolean asAdmin) {
        prepareSendingPhoto(imageFilePath, imageUri, dialog_id, reply_to_msg, caption, asAdmin, false);
    }
    public static void prepareSendingPhoto(String imageFilePath, Uri imageUri, long dialog_id, MessageObject reply_to_msg, CharSequence caption, boolean asAdmin, boolean asImage) {
        ...
        prepareSendingPhotos(paths, uris, dialog_id, reply_to_msg, captions, asAdmin, asImage);
    }
    ...
    public static void prepareSendingPhotos(ArrayList<String> paths, ArrayList<Uri> uris, final long dialog_id, final MessageObject reply_to_msg, final ArrayList<String> captions, final boolean asAdmin) {
        prepareSendingPhotos(paths, uris, dialog_id, reply_to_msg, captions, asAdmin, false);
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (int a = 0; a < count; a++) {
                    ...
                    if (isDocument && !asImageIfDocument) {
