...
public class ChatAudioCell extends ChatBaseCell implements SeekBar.SeekBarDelegate {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        timePaint.setColor(currentMessageObject.isOutOwner() ? colorPresenter.audioTimeOut : (isDrawSelectedBackground() ? colorPresenter.audioTimeInSelected :
                colorPresenter.audioTimeIn));
