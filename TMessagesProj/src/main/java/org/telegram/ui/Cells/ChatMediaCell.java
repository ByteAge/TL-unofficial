...
public class ChatMediaCell extends ChatBaseCell {
    ...
    protected void onAfterBackgroundDraw(Canvas canvas) {
        ...
        if (currentMessageObject.type == 9) {
            ...
            if (currentMessageObject.isOutOwner()) {
                infoPaint.setColor(colorPresenter.infoOut);
                docBackPaint.setColor(isDrawSelectedBackground() ? colorPresenter.docBackOutSelected : colorPresenter.docBackOut);
                menuDrawable = colorPresenter.docMenuDrawable[1];
            } else {
                infoPaint.setColor(isDrawSelectedBackground() ? colorPresenter.infoBackSelected : colorPresenter.infoBack);
                docBackPaint.setColor(isDrawSelectedBackground() ? colorPresenter.docBackSelected : colorPresenter.docBack);
                menuDrawable = colorPresenter.docMenuDrawable[isDrawSelectedBackground() ? 2 : 0];
            }
