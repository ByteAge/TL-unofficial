...
public class ChatMessageCell extends ChatBaseCell {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (hasLinkPreview) {
            ...
            replyLinePaint.setColor(currentMessageObject.isOutOwner() ? colorPresenter.replyLineOut : colorPresenter.replyLineIn);
            ...
            if (siteNameLayout != null) {
                replyNamePaint.setColor(currentMessageObject.isOutOwner() ? colorPresenter.replyOut : colorPresenter.replyIn);
                canvas.save();
