...
public class ChatMusicCell extends ChatBaseCell implements SeekBar.SeekBarDelegate {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (currentMessageObject.isOutOwner()) {
            timePaint.setColor(colorPresenter.timeOut//0xff70b15c
             );
        } else {
            timePaint.setColor(isDrawSelectedBackground() ? colorPresenter.audioTimeInSelected//0xff89b4c1
                            : colorPresenter.audioTimeIn//0xffa1aab3
            );
        }
