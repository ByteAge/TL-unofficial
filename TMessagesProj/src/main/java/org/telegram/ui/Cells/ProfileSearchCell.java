...
public class ProfileSearchCell extends BaseCell {
    ...
    public void buildLayout() {
        ...
        avatarImage.setImageCoords(avatarLeft, avatarTop=AndroidUtilities.dp(10), AndroidUtilities.dp(52), AndroidUtilities.dp(52));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(BuildConfig.DEBUG)
            Log.d("online? " + isOnline + " " + getClass());
        if(isOnline && drawOnline){
            if(BuildConfig.DEBUG)
                Log.d("drawing online");
