...
public class UserCell extends FrameLayout {
    ...
    public UserCell(Context context, int padding, int checkbox) {
        ...
        addView(mutualView, LayoutHelper.createFrame(12, 12, (LocaleController.isRTL ? Gravity.RIGHT : Gravity.LEFT) | Gravity.CENTER_VERTICAL,
                LocaleController.isRTL ?
                        AndroidUtilities.dp(65f) + avLeftMargin
                        : avLeftMargin - AndroidUtilities.dp(25f)
                ,
                0
                , LocaleController.isRTL ? padding - 15 : 0, 0));
        mutualView.setImageResource(R.drawable.contact_online);
