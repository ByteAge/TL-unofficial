...
public class ResourceLoader {
    ...
    public static void loadRecources(Context context) {
        if (backgroundDrawableIn == null) {
            ...
            backgroundDrawableInF = context.getResources().getDrawable(R.drawable.msg_in_f);
            backgroundDrawableInSelectedF = context.getResources().getDrawable(R.drawable.msg_in_selected_f);
            backgroundDrawableOutF = context.getResources().getDrawable(R.drawable.msg_out_f);
            backgroundDrawableOutSelectedF = context.getResources().getDrawable(R.drawable.msg_out_selected_f);
            backgroundMediaDrawableInF = context.getResources().getDrawable(R.drawable.msg_in_photo_f);
            backgroundMediaDrawableInSelectedF= context.getResources().getDrawable(R.drawable.msg_in_photo_selected_f);
            backgroundMediaDrawableOutF = context.getResources().getDrawable(R.drawable.msg_out_photo_f);
            backgroundMediaDrawableOutSelectedF = context.getResources().getDrawable(R.drawable.msg_out_photo_selected_f);
